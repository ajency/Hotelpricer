...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__importcsv__ = __webpack_require__(505);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ng2_date_picker__ = __webpack_require__(585);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_logout_popover_logout_popover_module__ = __webpack_require__(483);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_angular2_select__ = __webpack_require__(346);
...
ImportcsvPageModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_7__components_logout_popover_logout_popover_module__["a" /* LogoutPopoverComponentModule */],
...
var calendar_value_enum_1 = __webpack_require__(497);
...
var dom_appender_service_1 = __webpack_require__(495);
var utils_service_1 = __webpack_require__(485);
var calendar_type_enum_1 = __webpack_require__(496);
var calendar_value_enum_1 = __webpack_require__(497);
var date_picker_service_1 = __webpack_require__(583);
var core_1 = __webpack_require__(0);
...
var date_picker_directive_service_1 = __webpack_require__(582);
var date_picker_component_1 = __webpack_require__(490);
var core_1 = __webpack_require__(0);
var forms_1 = __webpack_require__(14);
...
var calendar_type_enum_1 = __webpack_require__(496);
var core_1 = __webpack_require__(0);
var day_calendar_service_1 = __webpack_require__(584);
var forms_1 = __webpack_require__(14);
var utils_service_1 = __webpack_require__(485);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__modals_importcsv_result_importcsv_result__ = __webpack_require__(342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_app_globals__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_auth_guard__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_filestack_js__ = __webpack_require__(562);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__popovers_import_sellerid_input_import_sellerid_input__ = __webpack_require__(345);
...
var ImportcsvPage = (function () {
    function ImportcsvPage(app, storage, location, repricerapi, appservice, modalctrl, appglobals, authguard, navCtrl, popoverctrl, events, zone) {
        this.app = app;
        ...
        this.blankTemplateName = "Products-empty-template";
        this.csvList = [];
        this.dummyCsvList = [];
        this.username = '';
        this.filterOptions = {
        ...
        this.enableUpdateFilter = false; // control update of filter from ngChange events in view
        ...
        this.fileStackClient = __WEBPACK_IMPORTED_MODULE_9_filestack_js__["a" /* default */].init(this.appglobals.getFileStackApiKey(), { policy: 'policy', signature: 'signature' });
    ...
    ImportcsvPage.prototype.marketSelected = function (market) {
        var _this = this;
        console.log(market);
        this.selectedMarket = {
            slug: market.value,
        ...
        setTimeout(function () {
            if (_this.selectedMarket.slug == '1') {
                // this.$(this.ngSelectHandle).find(".single .value:contains('" +this.selectedMarket.name+ "')").removeClass('flipkart');
                _this.$(_this.ngSelectHandle).find(".single .value:contains('" + _this.selectedMarket.name + "')").addClass('amazon');
            }
            else if (_this.selectedMarket.slug == '2') {
                // this.$(this.ngSelectHandle).find(".single .value:contains('" +this.selectedMarket.name+ "')").removeClass('amazon');
                _this.$(_this.ngSelectHandle).find(".single .value:contains('" + _this.selectedMarket.name + "')").addClass('flipkart');
            }
            else if (_this.selectedMarket.slug == 'all') {
                // this.$(this.ngSelectHandle).find(".single .value:contains('" +this.selectedMarket.name+"')").removeClass('amazon');
                // this.$(this.ngSelectHandle).find(".single .value:contains('" +this.selectedMarket.name+"')").removeClass('flipkart');
            }
        }, 250);
    ...
    // }
    ImportcsvPage.prototype.ionViewCanEnter = function () {
        var _this = this;
        console.log('ionviewcanenter ImportcsvPage');
        return new Promise(function (resolve, reject) {
            _this.authguard.verifyToken('import')
                .then(function () {
                _this.appglobals.setPageToNavigate({ page: 'import' });
                _this.currentPage = 'import';
                resolve(true);
            })
                .catch(function () {
                reject(true);
    ...
    ImportcsvPage.prototype.ionViewDidEnter = function () {
        // setTimeout(() => {
        ...
        this.listAllCsv()
            .then(function () {
            _this.enableUpdateFilter = true;
        })
            .catch(function () { return _this.enableUpdateFilter = true; });
        this.pollCsvListData();
        this.onPopStateHandler = function (history) {
            // console.log('onpop history => ', history);
            if (_this.resultModal) {
                _this.resultModal.dismiss();
            }
        };
        ...
        this.searchChangeCallback = function () {
            ...
            _this.paginationConfig.currentPage = 1;
            _this.updateFilter('search', 'searchtext');
        };
    ...
    ImportcsvPage.prototype.ionViewWillLeave = function () {
        console.log("imortcsv ionViewWillLeave");
        this.stopPollingCsvList();
    };
    ImportcsvPage.prototype.ionViewWillUnload = function () {
    ...
    ImportcsvPage.prototype.stopPollingCsvList = function () {
        clearInterval(this.pollingInterval);
    };
    ImportcsvPage.prototype.autoSearchUploads = function (event) {
    ...
    ImportcsvPage.prototype.pagChanged = function (page) {
        console.log(page);
        this.paginationConfig.currentPage = page;
        this.listAllCsv(page)
            .then(function () { return console.log('fetched'); })
            .catch(function () { return console.warn('fetche error'); });
    };
    ImportcsvPage.prototype.showPicker = function (payload) {
        var _this = this;
        this.pickerClosed = false;
        console.log("payload", payload);
        console.log("filestack version => ", __WEBPACK_IMPORTED_MODULE_9_filestack_js__["a" /* default */].version);
        this.stopPollingCsvList();
        var fileStackClient = __WEBPACK_IMPORTED_MODULE_9_filestack_js__["a" /* default */].init(this.appglobals.getFileStackApiKey(), { policy: 'policy', signature: 'signature' });
        fileStackClient.pick({
            maxFiles: 1,
            accept: [".xlsx", "xls", ".csv", ".txt"],
            fromSources: ['local_file_system', 'googledrive', 'dropbox'],
            // onOpen: () => {console.log("picker open")},
            onClose: function (event) { console.log("picker close", event); setTimeout(function () { _this.pickerClosed = true; }, 500); _this.pollCsvListData(); },
        })
            .then(function (result) {
            console.log("pick then =>", result.filesUploaded);
            console.log('picker closed', _this.pickerClosed);
            if (_this.pickerClosed)
                return;
            var filesuploaded = result.filesUploaded;
            if (filesuploaded.length) {
                payload['filename'] = filesuploaded[0]["filename"];
                payload['url'] = filesuploaded[0]["url"];
                _this.importsheet(payload);
            }
            else {
                var mes = "file upload to filestack failed";
                console.warn(mes);
                _this.appservice.presentToast(mes, 'error');
            }
        })
            .catch(function (err) {
    ...
    ImportcsvPage.prototype.showResult = function (id, filename, status) {
        var _this = this;
        ...
        this.repricerapi.setResultPopover(modaldata);
        this.resultModal = this.modalctrl.create(__WEBPACK_IMPORTED_MODULE_6__modals_importcsv_result_importcsv_result__["a" /* ImportcsvResultPopoverPage */]);
        this.resultModal.present({
            updateUrl: false
        });
        this.resultModal.onDidDismiss(function (data) {
            console.log("result modal dismissed");
            _this.pollCsvListData(true);
            _this.pollCsvListData();
            _this.resultModal = null;
            _this.$(_this.content.getNativeElement()).removeClass("disabled-view");
            if (data) {
                _this.location.back();
            }
        });
    ...
    //   }
    // }
    ImportcsvPage.prototype.updateSearchType = function (slug) {
        this.filterOptions.search.selected = slug;
        // this.toggleFileNameDrop();
        this.updateFilter('search');
    };
    ImportcsvPage.prototype.delayModelUpdate = function (type) {
        var _this = this;
        setTimeout(function () {
            _this.updateFilter(type);
        }, 250);
    };
    ImportcsvPage.prototype.updateFilter = function (type, searchtext) {
        if (searchtext === void 0) { searchtext = null; }
        console.log("$event", event);
        if (!this.enableUpdateFilter) {
            return;
        }
        var container = this.filterOptions[type];
    ...
    ImportcsvPage.prototype.applyFilters = function (resolvetype) {
        var _this = this;
        if (resolvetype === void 0) { resolvetype = 'promise'; }
        this.applyFilterFlag = true;
        this.paginationConfig["itemsPerPage"] = this.defaultFilters.limit;
        this.paginationConfig["currentPage"] = this.defaultFilters.page;
        this.listAllCsv(1, resolvetype)
            .then(function () { return _this.applyFilterFlag = false; })
            .catch(function () { return _this.applyFilterFlag = false; });
    };
    ImportcsvPage.prototype.resetFilters = function () {
        var _this = this;
    ...
    ImportcsvPage.prototype.hideAllDrops = function (excludekey) {
        var x;
    ...
    ImportcsvPage.prototype.resetFilterTemlate = function () {
    ...
    ImportcsvPage.prototype.toggleFileNameDrop = function () {
        console.log("saffsd");
    ...
    ImportcsvPage.prototype.listAllCsv = function (page, type) {
        var _this = this;
        if (page === void 0) { page = 1; }
        if (type === void 0) { type = 'promise'; }
        ...
        if (type === 'promise') {
            return new Promise(function (resolve, reject) {
                _this.repricerapi.listCsvUploads(_this.filters, type)
                    .then(function (res) {
                    console.log("response", res);
                    _this.csvListloading = false;
                    _this.paginationConfig.totalItems = res.result_count;
                    _this.paginationConfig.itemsPerPage = res.results_per_page;
                    _this.csvList = res.data;
                    _this.showUploadMessage(res.message, res.query_data.hideAlertBox);
            ...
            this.reqSubscription = this.repricerapi.listCsvUploads(this.filters, type)
                ...
                _this.reqSubscription.unsubscribe();
                _this.reqSubscription = null;
                _this.zone.run(function () { });
            });
        }
    };
    ImportcsvPage.prototype.subscribeToCsvList = function () {
        var _this = this;
        ...
        this.pollSubscription = this.repricerapi.listCsvUploads(this.filters, 'observable')
            ...
            _this.pollSubscription.unsubscribe();
            _this.pollSubscription = null;
        });
    };
    ImportcsvPage.prototype.pollCsvListData = function (singlepoll) {
        var _this = this;
        if (singlepoll === void 0) { singlepoll = false; }
        if (singlepoll) {
            this.subscribeToCsvList();
        }
        else {
            this.pollingInterval = setInterval(function () {
                _this.subscribeToCsvList();
            }, this.appglobals.getPollInterval());
        }
    };
    ImportcsvPage.prototype.goBack = function () {
        this.location.back();
    };
    ImportcsvPage.prototype.toggleFilterView = function () {
        this.hideFilterView = !this.hideFilterView;
        console.log('filter view ' + (this.hideFilterView ? 'hidden' : 'visible'));
        this.zone.run(function () { });
    };
    ImportcsvPage.prototype.downloadBlankTemplate = function () {
        var _this = this;
        var reqbody = Object.assign({}, this.templatepayload);
        ...
        this.repricerapi.exportTemplate(reqbody)
            .then(function (res) {
            console.log(res);
            _this.appservice.downloadFile(res.file, _this.blankTemplateName);
        })
            .catch(function (err) {
            console.warn(err);
        });
    };
    ImportcsvPage.prototype.downImportedFile = function (id) {
        var _this = this;
    ...
    ImportcsvPage.prototype.uploadSheet = function () {
    ...
    ImportcsvPage.prototype.navTo = function (page, market, filter) {
        if (market === void 0) { market = ''; }
        console.log('navigating to page', page);
        var params = {};
        if (market) {
    ...
    ImportcsvPage.prototype.showSellerPopover = function () {
        var _this = this;
        var payload = {
            type: "import",
            filename: '',
        ...
        if (payload["marketplace_id"] === 'custom') {
            ...
            this.sellerPopover = this.popoverctrl.create(__WEBPACK_IMPORTED_MODULE_10__popovers_import_sellerid_input_import_sellerid_input__["a" /* ImportSellerInput */], { payload: payload }, { enableBackdropDismiss: false });
            this.sellerPopover.present();
            this.sellerPopover.onDidDismiss(function (sellerid) {
                if (!sellerid)
                    return;
                console.log('seller popover dismisses ', sellerid);
                payload["seller_id"] = sellerid;
                _this.showPicker(payload);
            });
        }
    }; //end showSellerPopover
    ImportcsvPage.prototype.importsheet = function (payload) {
        var _this = this;
        this.importSuccess = false;
        ...
        this.repricerapi.importTemplate(payload)
            ...
            _this.showFadeIn = false;
            _this.showAlertSuccess = false;
            _this.listAllCsv()
                .then(function () { return console.log('fetched'); })
                .catch(function () { return console.warn('fetche error'); });
            if (res.success == true) {
                if (!_this.appMeta.user['dummy_cleared']) {
                    _this.appMeta.user['dummy_cleared'] = _this.dummyCleared = true;
                    _this.repricerapi.setUser(_this.appMeta.user);
                    _this.storage.set("appMeta", _this.appMeta);
                }
                _this.appservice.presentToast('Sheet uploaded successfully');
                _this.importSuccess = true;
                _this.saveSellerID(payload);
            }
            else {
                var errmess = '';
                if (res.errors && res.errors.length) {
                    ...
                    for (var _i = 0, _a = res.errors; _i < _a.length; _i++) {
                        ...
                        if (typeof err === 'string') {
                            ...
                            var line = "(Row: " + err["row"] + ", Error: " + err["error"] + ")";
                            errors.push(line);
                        }
                    }
                    errmess = errmess + errors.join('\n');
                    _this.appservice.presentToast(errmess, 'error', 15000);
                }
                else {
                    errmess = res.status ? res.status : 'File import failed!';
                    _this.appservice.presentToast(errmess, 'error');
                }
            }
            _this.pollCsvListData();
            _this.importingSheet = false;
            _this.zone.run(function () { });
        })
            .catch(function (err) {
    ...
    ImportcsvPage.prototype.saveSellerID = function (payload) {
    ...
    ImportcsvPage.prototype.hideAllFilters = function (event) {
    ...
    ImportcsvPage.prototype.setImportMarket = function () {
        console.log("import sfasf");
    };
    ImportcsvPage.prototype.downloadFile = function (market, name) {
        var url = this.appglobals.getInstrSheetUrls()[market];
        this.appservice.downloadFile(url, name, 'pdf');
    };
    ImportcsvPage.prototype.hideAlert = function (keepHidden, last_import_id) {
        this.showAlertSuccess = false;
        if (keepHidden == 1) {
    ...
    ImportcsvPage.prototype.onContextMenu = function (event, page) {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('customSelect'),
    __metadata("design:type", Object)
], ImportcsvPage.prototype, "customSelect", void 0);
__decorate([
...
], ImportcsvPage.prototype, "content", void 0);
ImportcsvPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* App */],
        ...
        __WEBPACK_IMPORTED_MODULE_7__providers_app_globals__["a" /* AppGlobals */],
        __WEBPACK_IMPORTED_MODULE_8__providers_auth_guard__["a" /* AuthGuard */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
...
var date_picker_component_1 = __webpack_require__(490);
var date_picker_directive_1 = __webpack_require__(498);
var day_calendar_component_1 = __webpack_require__(499);
var dom_appender_service_1 = __webpack_require__(495);
var month_calendar_component_1 = __webpack_require__(586);
var utils_service_1 = __webpack_require__(485);
var calendar_nav_component_1 = __webpack_require__(580);
var date_picker_component_2 = __webpack_require__(490);
exports.DatePickerComponent = date_picker_component_2.DatePickerComponent;
var date_picker_directive_2 = __webpack_require__(498);
exports.DatePickerDirective = date_picker_directive_2.DatePickerDirective;
var day_calendar_component_2 = __webpack_require__(499);
...
var core_1 = __webpack_require__(0);
var month_calendar_service_1 = __webpack_require__(587);
var forms_1 = __webpack_require__(14);
var utils_service_1 = __webpack_require__(485);
