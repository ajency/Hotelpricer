...
class ProductsController extends AppController
{
    ...
    public $paginate = [
        ...
        'maxLimit' => 100,
        'fields' => [
            'id', 'marketplace_id', 'listing_id', 'sku_code', 'min', 'max', 'rule_id', 'product_family', 'status', 'user_id'
        ],
        'sortWhitelist' => [
    ...
    public function add()
    {
        ...
        $rules = $this->Products->Rules->find('list', ['limit' => 200]);
        $users = $this->Products->Users->find('list', ['limit' => 200]);
        $this->set(compact('product', 'rules', 'users'));
        $this->set('_serialize', ['product']);
    }
