...
/**
 * PricingRuleActionsFixture
 *
 */
class PricingRuleActionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'allow_price_input' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null],
        'operators' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        '_constraints' => [
